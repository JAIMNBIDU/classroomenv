...
# Harden log file permissions on first write (root only)
try:
...
# ─────────────────────────────────────────────
#  PROCESS LOCK
#  Prevents two instances running simultaneously.
#  Silent to the user unless there's a conflict.
# ─────────────────────────────────────────────
import fcntl
...
def _save_state(state):
    ...
    # Root-only read/write — state should not be world-readable
...
def _banner():
    ...
    art = r"""
  _________ .__
  \_   ___ \|  | _____    ______ ________________  ____   ____   _____   ____  __ __
  /    \  \/|  | \__  \  /  ___//  ___/\_  __ \  \/  /  / __ \ /    \  \   \\/  |
  \     \___|  |__/ __ \_\___ \ \___ \  |  | \/\     /\  ___/|   |  \  \    /|  |
   \______  /____(____  /____  >____  > |__|   \/\_/   \___  >___|  /   \/\_/ |____|
          \/          \/     \/     \/                      \/     \/"""
...
def _show_profile_and_confirm(profile_name):
    ...
    # ── Go warning if this profile needs it ──────────
...
#  Also accessible from the main menu as [r].
# ─────────────────────────────────────────────

# Tools that require Go to install
